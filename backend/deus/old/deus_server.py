...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        f.write(b"<html><head><link rel='stylesheet' href='dist/css/bootstrap.min.css'></head><body class='p-5'>")
    ...
    def list_directory(self, path):
        ...
        f.write(b'<meta name="viewport" content="width=device-width, initial-scale=1">')
        f.write(b'<link rel="stylesheet" href="dist/css/bootstrap.min.css">')
        f.write(b'<style>')
