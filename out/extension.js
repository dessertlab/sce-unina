...
class UploadProvider {
    ...
    async getChildren() {
        return [
            new UploadNode("Upload Exam Project", "sce-unina.uploadExam", "Click to upload your exam project", "cloud-upload"),
            new UploadNode("Download Exam Files", "sce-unina.getExam", "Click to download your exam files", "cloud-download"),
            new UploadNode("Configure Server Host", "sce-unina.configureServerHost", `Current server: ${await getServerUrl()}`, "settings-gear")
        ];
    }
}
/* add for testing */
